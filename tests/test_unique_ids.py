...
EXPECTED_ENTITIES: list[tuple[str, str, str]] = [
    ...
    ("sensor", "migo_netatmo_energy_gas_heating_gateway_001", "sensor.my_home_gateway_gas_for_heating"),
    ("sensor", "migo_netatmo_energy_gas_hot_water_gateway_001", "sensor.my_home_gateway_gas_for_hot_water"),
